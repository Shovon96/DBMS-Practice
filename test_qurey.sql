...
-- Insert data on the departments table
...
-- Which department are have how many people are have
...
-- How many emplooyes are hired in which year
SELECT extract(YEAR from hire_date) as hire_year, count(*) from employees
GROUP BY hire_year;



-- Create another table of Orders
CREATE TABLE orders (
